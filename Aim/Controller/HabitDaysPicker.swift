//
//  HabitDaysPicker.swift
//  Aim
//
//  Created by Alexandru Turcanu on 27/07/2018.
//  Copyright © 2018 Alexandru Turcanu. All rights reserved.
//

import UIKit

class HabitDaysPicker: UIPickerViewController {

    override func layoutContent() -> [UIView] {
        let colorsView = UIView()
        colorsView.translatesAutoresizingMaskIntoConstraints = false
        colorsView.backgroundColor = .blue
...
//  FBSnapshotTestCase
//
//  Created by Erick Sanchez on 5/24/18.
//
import Foundation
...
open class UIPickerViewController: UIViewController {
    ...
    open func present(in viewController: UIViewController) {
        ...
        //set up animation
        centerYConstraint.constant = view.bounds.height + containerView.bounds.height / 2
        self.view.layoutIfNeeded()
//
    }
    ...
    open override func loadView() {
        ...
        centerYConstraint = self.containerView.centerYAnchor.constraint(equalTo: self.view.centerYAnchor)
